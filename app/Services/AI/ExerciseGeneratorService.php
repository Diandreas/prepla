...
DIRECTIVE;
        ...
        $questionFormat = match ($componentKey) {
            ...
            'oral-debate' => 'Array of 1 question with: id (string), type ("role-play"), scenario (a debatable topic + the examiner\'s stance, in ' . $language . '), role ("Tu défends ton point de vue face à l\'examinateur"), dialogue_turns (array of 6 objects ALTERNATING: examiner turns have text = a provocative claim/counter-argument in ' . $language . '; candidate turns have prompt = what to argue, e.g. "Réfute cet argument avec un exemple"), correct_answer (null)',
