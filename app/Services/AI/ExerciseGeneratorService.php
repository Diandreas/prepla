...
DIRECTIVE;
        ...
        $questionFormat = match ($componentKey) {
            ...
            'form-completion' => 'Array of 1 question with: id (string), type ("form-completion"), text (instruction in ' . $instructionLang . '), fields (array of 6-8 objects {label: string in ' . $language . ', value: string or "" for blanks, type: "text"|"date"|"select", options?: string[] for select}), correct_answers (object mapping blank field indices to correct values)',
