    ...
    'sections' => [
        ...
        [
            ...
            'parts' => [
                [
                    'part' => 1,
                    'name' => 'Lesetext 1',
                    'description' => 'Short texts (university life): match texts to statements. 8 items.',
                    'question_count' => 8,
                ],
                [
                    'part' => 2,
                    'name' => 'Lesetext 2',
                    'description' => 'Journalistic text: MCQ and true/false. 10 items.',
                    'question_count' => 10,
                ],
                [
                    'part' => 3,
                    'name' => 'Lesetext 3',
                    'description' => 'Academic/scientific text: detailed comprehension MCQ. 12 items.',
                    'question_count' => 12,
                ],
            ],
            'exercise_types' => [
        ...
        [
            ...
            'tasks' => [
                [
                    'task' => 1,
                    'name' => 'Schriftlicher Ausdruck 1',
                    'description' => 'Describe and interpret a chart/graph/statistic. Minimum 150 words.',
                    'min_words' => 150,
                    'time_suggestion' => 20,
                ...
                [
                    'task' => 2,
                    'name' => 'Schriftlicher Ausdruck 2',
                    'description' => 'Write an argumentative essay on an academic topic. Minimum 250 words.',
                    'min_words' => 250,
                    'time_suggestion' => 40,
                    'exercise_type' => 'essay',
                ],
